...
# define GPIO_PIN_SET_CALLBACK(ns, p, callback, data, inter) int32_t gpioPin_setCallback(struct gpio_pin *p, bool (*callback)(struct gpio_pin *pin, void *data), void *data, enum gpio_interrupt inter)
...
# define GPIO_PIN_SET_CALLBACK(ns, p, callback, data, inter) static int32_t ns##_gpioPin_setCallback(struct gpio_pin *p, bool (*callback)(struct gpio_pin *pin, void *data), void *data, enum gpio_interrupt inter)
